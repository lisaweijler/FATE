...
class LoggingManager():
    ...
    def register_handlers(self, level = logging.DEBUG, name: str =None, save_path: Path=None) -> None:
        ...
        if self.config.enable_file_log_handler:
            if save_path is None:
                raise ValueError("If enable_file_log_handler is set to True, save_path has to be specified but None given.") 
